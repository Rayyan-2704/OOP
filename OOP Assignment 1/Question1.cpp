...
class Student{
    ...
    string studentName;
    int studentAge;
    Sport **sportsInterests;  // pointer to an array of Sports
    int numSports;
...
class Mentor{
    string mentorID;
    string mentorName;
    Sport **sportExpertise;  // pointer to an array of Sports
    int numSports;
    int maxLearners;
    Student **assignedLearners;  // pointer to an array of Students
    int currentLearners;
...
int main() {
    ...
    int choice;
    cout << endl << "===== MENU =====" << endl;
    cout << "1. Display Mentor Details" << endl;
    cout << "2. Display Student Details" << endl;
    cout << "3. View Learners of Mentor" << endl;
    cout << "4. Provide Guidance" << endl;
    cout << "5. Add Skill to Sport1" << endl;
    cout << "6. Remove Skill from Sport1" << endl;
    cout << "7. Display Sport1 Details" << endl;
    cout << "8. Display Sport2 Details" << endl;
    cout << "9. Exit" << endl;
    do {
